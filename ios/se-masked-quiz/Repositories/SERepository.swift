...
struct SERepository: Sendable {
  ...
  func fetch(offset: Int) async throws -> [SwiftEvolution] {
    ...
    let requestURL = try Self.proposalsURL(baseURL: baseURL, offset: offset, limit: Self.pageSize)
  ...
  private static func proposalsURL(baseURL: String, offset: Int, limit: Int) throws -> URL {
